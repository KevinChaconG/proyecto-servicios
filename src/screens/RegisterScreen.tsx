...
const RegisterScreen: React.FC<RegisterScreenProps> = ({ navigation }) => {
    ...
    const handleRegister = async () => {
        ...
        try {
            const rol = Esemprendedor ? 'EMPRENDEDOR' : 'CLIENTE';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.roleContainer}>
                ...
                <Switch
                    ...
                    thumbColor={Esemprendedor ? "#f5dd4b" : "#f4f3f4"}
                    onValueChange={setEsemprendedor}
                    value={Esemprendedor}
                />
                <Text style={styles.roleStatus}>{Esemprendedor ? 'Sí' : 'No (Soy Cliente)'}</Text>
            </View>
